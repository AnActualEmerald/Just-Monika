module.exports = {
    ...
    description:
        "Restricts a roll or member from typing in the channel called in",
    args: true,
    ...
    execute(message, args, bot) {
        ...
        if (user != null) {
            ...
            message.channel
                .overwritePermissions(user, { SEND_MESSAGES: false })
                .then(channel =>
        ...
        if (role != null) {
            ...
            message.channel
                .overwritePermissions(role, { SEND_MESSAGES: false })
                .then(channel =>
                    channel.send(`Updated permissions for this channel`)
                )
                .catch(bot.logger.error);
